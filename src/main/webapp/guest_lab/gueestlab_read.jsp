...
<body>
	...
	*/
	...
	<table width='600' cellspacing='0' cellpadding='2' align='center'>
		...
		<tr align='center' bgcolor='#DFEDFF'>
			<td class='button' bgcolor='#DFEDFF'>
				<div align='left'>
					<font size='4'> 글제목 : <%=rs.getString("subject")%>
				</div>
			</td>
		</tr>
		...
		<tr align='center'>
			<td style='padding: 10 0 0 0'>
				<div align='left'>
					<br> <font size='3' color='#333333'> <pre> <%=rs.getString("content")%> </pre>
				</div> <br>
			</td>
		</tr>
		<tr align='center'>
	...
	<table width="600" border="0" cellpadding="0" cellspacing="5">
		<tr>
			<td align="right" width="450"><A href="freelab_list03.jsp"><img
					src="image/list.jpg" border=0></a></td>
			<td width="70" align="right"><A href="freeboard_rwrite.jsp">
					<img src="image/reply.jpg" border=0>
			</A></td>
			<td width="70" align="right"><A href="gueestlab_upd.jsp"><img
					src="image/edit.jpg" border=0></A></td>
			<td width="70" align="right"><A href="gueestlab_del.jsp"><img
